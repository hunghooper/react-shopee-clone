      ...
      <div className="container">
          ...
          <div className="min-w-[1000px]">
              ...
              <div className="col-span-6">
                <div className="flex items-center">
                  <div className="flex flex-shrink-0 items-center justify-center pr-3">
                    <input type="checkbox" className="w-5 h-5 accent-shopee_orange" />
                  </div>
            ...
            <div className="my-3 bg-white rounded-sm p-5 shadow">
              {purchaseInCart?.map((purchase) =>
                <div key={purchase._id} className="grid grid-cols-12 py-5 px-4 mb-5 first:mt-0 text-center text-sm text-gray-500 rounded-sm border bg-white border-gray-200">
                  <div className="col-span-6">
                    <div className="flex">
                      <div className="flex flex-shrink-0 items-center justify-center pr-3">
                        <input type="checkbox" className="w-5 h-5 accent-shopee_orange" />
                      ...
                      <div className="flex flex-grow">
                        <div className="flex">
                          <Link to={`${path.home}${generateNameId({ name: purchase.product.name, id: purchase.product._id })}`} className="w-20 h-20 flex-shrink-0">
                            <img src={purchase.product.image} alt={purchase.product.name} className="w-20 h-20" />
                          </Link>
                          <div className="flex-grow pt-1 px-2 pb-2">
                            <Link to={`${path.home}${generateNameId({ name: purchase.product.name, id: purchase.product._id })}`} className="line-clamp-2">
                  ...
                  <div className="col-span-6">
                    <div className="grid grid-cols-5 items-center">
                      ...
                      <div className="col-span-1">
                        <button className="bg-none text-black transition-colors hover:text-shopee_orange">Remove</button>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="sticky bottom-0 z-10 flex rounded-sm border border-gray-100 bg-white p-5 shadow mt-8 flex-col md:flex-row sm:items-center">
          ...
          <div className="sm:ml-auto mt-5 flex flex-col sm:mt-0 sm:flex-row sm:items-center">
            ...
            <Button className="h-10 w-52 sm:ml-4 mt-5 flex items-center justify-center text-sm uppercase bg-shopee_orange text-white hover:bg-shopee_orange/75 sm:mt-0">Checkout</Button>
          </div>
        </div>
      </div>
    </div>
